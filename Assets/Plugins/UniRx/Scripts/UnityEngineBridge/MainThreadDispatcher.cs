...
#pragma warning restore CS0618
        ...
        public static void StartLateUpdateMicroCoroutine(IEnumerator routine)
        {
#if UNITY_EDITOR
            if (!ScenePlaybackDetector.IsPlaying) { EditorThreadDispatcher.Instance.PseudoStartCoroutine(routine); return; }
#endif
            ...
            if (dispatcher != null)
            {
                dispatcher.lateUpdateMicroCoroutine.AddCoroutine(routine);
            }
        }
        ...
        private MicroCoroutine lateUpdateMicroCoroutine;
